...
image_path = os.path.join(dir, 'data','driving_log.csv')
...
model.fit(X_train, y_train, validation_data = (X_val, y_val), nb_epoch=2, shuffle=True) #, shuffle=True, validation_split=0.1
